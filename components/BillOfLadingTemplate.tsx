...
export function BillOfLadingTemplate({ shipment, totalPrice, productPrice, deliveryCost }: BillOfLadingTemplateProps) {
  ...
  const calculatedShipping = shipment.price;
  const grandTotal = shipment.price + itemsTotal;
